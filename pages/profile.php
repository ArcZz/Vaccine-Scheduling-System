                        ...
                        <form>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>SSN </label>
                                        <input class="form-control" type="text" value="123-234-2344">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Date Of Birth</label>
                                        <input class="form-control " value="1998-03-14" type="text">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Max Travel Distance (in Miles)</label>
                                        <input class="form-control" value="20" type="text">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
